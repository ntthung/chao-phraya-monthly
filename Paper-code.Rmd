...
w4cvQ <- cv_mb(w4tar, w4pcAllseasons$l25, w4cvFolds, 1750, 
        lambda = 10, 
        log.trans = NULL, force.standardize = TRUE,
        return.type = 'Q')[season != 'Ann']
...
y17cvQ <- cv_mb(y17tar, y17pcAllseasons$l25, y17cvFolds, 1750, 
        lambda = 0, 
        log.trans = NULL, force.standardize = TRUE,
        return.type = 'Q')[season != 'Ann']
...
n1cvQ <- cv_mb(n1tar, n1pcAllseasons$l25, n1cvFolds, 1750, 
        lambda = 10, 
        log.trans = NULL, force.standardize = TRUE,
        return.type = 'Q')[season != 'Ann']
